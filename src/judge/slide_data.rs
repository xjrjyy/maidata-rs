...
pub static STRAIGHT_DATA: [&[HitAreaData]; 8] = [
    ...
    &[
        ...
        HitAreaData::new(&[TouchSensor::new_unchecked('C', Some(0))], 218.6302947998047, 42.19921875),
...
pub static BEND_L_DATA: [&[HitAreaData]; 8] = [
    ...
    &[
        ...
        HitAreaData::new(&[TouchSensor::new_unchecked('B', Some(7)), TouchSensor::new_unchecked('C', Some(0))], 151.8427276611328, 16.465057373046875),
